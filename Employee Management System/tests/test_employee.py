...
class TestAddEmployee(unittest.TestCase):
    ...
    @patch("src.employee.get_employee_name",return_value="Rahul")
    @patch("src.employee.get_employee_id",return_value=101)
    ...
    def test_duplicate_employee_id_is_not_added(self):
        employee.employees.append({"id": 101,"name": "Rahul"})
        with patch("src.employee.get_employee_id",return_value=101):
            with patch("src.employee.get_employee_name",return_value="Amit"):
                employee.add_employee()
        self.assertEqual(len(employee.employees), 1)
        self.assertEqual(employee.employees[0]["name"], "Rahul")
...
class TestRemoveEmployee(unittest.TestCase):
    ...
    @patch("src.employee.get_employee_id",return_value=999)
...
class TestUpdateEmployee(unittest.TestCase):
    ...
    @patch("src.employee.get_employee_name",return_value="Amit")
    @patch("src.employee.get_employee_id",return_value=101)
