...
from src.employee_management import main
...
class TestLoadData(unittest.TestCase):
    ...
    @patch("src.employee_management.main.os.path.exists", return_value=False)
    def test_load_data_when_file_does_not_exist(self, mock_exists):
        main.load_data()
        self.assertEqual(main.employees, [])

    @patch("src.employee_management.main.os.path.exists", return_value=True)
...
class TestSaveData(unittest.TestCase):
    ...
    @patch("src.employee_management.main.open", new_callable=mock_open)
    ...
    @patch("src.employee_management.main.open",side_effect=OSError("File cannot be written"))
...
class TestHandleMenuChoice(unittest.TestCase):
    @patch("src.employee_management.main.save_data")
    @patch("src.employee_management.main.add_employee")
    ...
    @patch("src.employee_management.main.save_data")
    @patch("src.employee_management.main.remove_employee")
    ...
    @patch("src.employee_management.main.save_data")
    @patch("src.employee_management.main.update_employee")
    ...
    @patch("src.employee_management.main.find_employee")
    ...
    @patch("src.employee_management.main.list_employees")
    ...
    @patch("src.employee_management.main.search_employees")
...
class TestRunApplication(unittest.TestCase):
    @patch("src.employee_management.main.handle_menu_choice",return_value=False)
    @patch("src.employee_management.main.get_menu_choice",return_value=7)
    @patch("src.employee_management.main.display_menu")
    @patch("src.employee_management.main.load_data")
