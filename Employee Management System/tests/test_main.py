...
class TestLoadData(unittest.TestCase):
    ...
    @patch(
        "builtins.open",
        side_effect=OSError("File could not be opened")
    )
    def test_load_data_when_file_cannot_be_read(
        self,
        mock_open_file,
        mock_exists
    ):
...
class TestSaveData(unittest.TestCase):
    ...
    @patch(
        "src.main.open",
        side_effect=OSError("File cannot be written")
    )
    def test_save_data_when_file_cannot_be_written(
        self,
        mock_open_file
    ):
        main.save_data()
...
class TestHandleMenuChoice(unittest.TestCase):
    ...
    def test_add_employee_menu_choice(
        self,
        mock_add_employee,
        mock_save_data
    ):
    ...
    def test_remove_employee_menu_choice(
        self,
        mock_remove_employee,
        mock_save_data
    ):
    ...
    def test_update_employee_menu_choice(
        self,
    ...
    def test_find_employee_menu_choice(
        self,
        mock_find_employee
    ):
    ...
    def test_list_employee_menu_choice(
        self,
        mock_list_employees
    ):
    ...
    def test_search_employee_menu_choice(
        self,
        mock_search_employees
    ):
...
class TestRunApplication(unittest.TestCase):
    ...
    def test_application_exits_safely(
        self,
        mock_load_data,
        mock_display_menu,
        mock_get_menu_choice,
        mock_handle_menu_choice
    ):
